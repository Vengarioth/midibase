...
pub enum Command {
    ...
    Run {
        ...
        #[structopt(name = "SINKS", short = "s", long = "sinks", default_value = "5", help = "The number of Roido::Sink in the audio pool, larger values let you play more sounds in parallel")]
        sinks: u64
    },
}
